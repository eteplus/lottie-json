...
import { OffsetKeyframe, Value } from '../properties';

export type PreCompLayer = {
  /**
   * Type
   * @desc Type of layer: PreComp
   */
  ...
  /**
   * Reference ID
   * @desc id pointing to the source image defined on 'assets' object
   */
  refId?: string;
  /**
   * Time Remapping
   * @desc Comp's Time remapping
   */
  tm?: Value<number | OffsetKeyframe[]>;
  /**
   * 宽 - Width
   * @desc Layer Width
   */
